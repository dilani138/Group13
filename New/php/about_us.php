...
<div class="contianer">
    ...
    <div class="content">
        ...
        <div class= "col-b-1 left" >    
		<div class= "col-c-1 left" >
            <h1> About Us </h1>
        ...
        <div class= "col-c-1 left" >
        	...
        	<ul>
        		<li> Formulation and providing of vocational training programs to youth and make them competent in association with relevant other institutions.</li>
        ...
        <div class= "col-c-1 left" >
        	...
        	<ul>
			   ...
			   <li> Team </li>
			    ...
			    <li>Being committed to continuous growth towards satisfaction of trainees and other stackeholders in a changing environment
			    </li>
        	</ul>
        </div>
        </div>
        ...
        <div class= "col-c-1 left" >
        	...
        	<ul>
			    ...
			    <li>Conduct research on vocational training and development programs.</li>
         ...
         <div class= "col-b-1 left" >
         <div class= "col-c-1 left" >
         <img src="../images/bg.png" width="100%" height="100px" />
         </div>
         </div>
