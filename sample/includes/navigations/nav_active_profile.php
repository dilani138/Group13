	...
	<div class= "nav" > <!-- RESPONSIVE FOR DIFFERENT SCREEN SIZES -->
		...
		<input type="checkbox" id="show-menu" role="button">	
			...
			<ul id="menu" >  <!-- NAVIGATION BEGIN HERE -->
				...
				<li> <a href="../../php/skill_directory/login_page.php" class= "active"> <i class= "fa fa-user fa-lg " ></i>&nbsp Profiles </a> </li> <!-- PROFILES PAGE -->
				
				<li> <a href="../../php/home/faqs.php"> FAQs </a> </li> <!-- FAQS PAGE -->
...
<hr style="width:100%; height: 5px; color: #0000cc; background-color: #0000cc;">
